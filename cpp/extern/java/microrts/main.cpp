...
int main() {
    ...
    auto cls = java.getClass("rts/MicroRTS").main({
            "-f",
            "config.properties"
    });
    ...
    auto gameSettingsEnum = java
            .getEnum("rts/GameSettings$LaunchMode")
            .getEnumValueLong("STANDALONE");
